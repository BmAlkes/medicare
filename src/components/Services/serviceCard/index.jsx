  ...
  return (
    <div className="py-[30px] px-3 lg:px-5">
        ...
        <Link
                  ...
                  <span className="w-[44px] h-[44px] flex items-center justify-center text-[18px] left-[30px] font-[600]" style={{background:`${bgColor}`, color:`${textColor}`, borderRadius:'6px'}}>{index + 1}</span>
        </div>
    </div>
  )
}
