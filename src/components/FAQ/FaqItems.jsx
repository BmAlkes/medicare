...
const FaqItems = ({ faq }) => {
  ...
  return (
    <div className="p-3 lg:p-5 rounded-[12px] border border-solid border-[#d9dce2] mb-5 cursor-pointer">
      ...
      >
        <h4 className="text-[16px] leading-7 lg:text-[20px] lg:leading-8 text-textColor ">
          {faq.question}
        </h4>
        <div
          className={`${
            isOpen && "bg-primaryColor text-white border-none"
          } w-7 h-7 lg:w-8 lg:h-8 border border-solid border-[#121f21] rounded flex items-center justify-center`}
        >
